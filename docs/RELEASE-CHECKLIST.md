...
```bash
bun run check:release-tag -- v0.2.0
bun run check
...
Use [releases/v0.2.0.md](releases/v0.2.0.md) as the release body and
...
```bash
gh skill install kmarchais/trace-review trace-review@v0.2.0 --dir <temporary-directory>
npx skills add \
  https://github.com/kmarchais/trace-review/tree/v0.2.0/skills/trace-review \
  --agent codex --yes
```
